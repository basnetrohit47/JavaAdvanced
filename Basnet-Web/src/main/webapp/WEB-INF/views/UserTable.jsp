...
<div class="jumbotron text-center">
  ...
  <p>Responsive Bootstrap web application</p> 
</div>
  ...
  <div class="modal" id="turtle-info">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h2>{{list.activeTurtle.type}}Add Or Update Student</h2>
                        </div>
    ...
    <div class="form-group">
        <label>Name</label>
        <input type="text" name="name" id="name" class="form-control" data-ng-model="user.fullname">
...
<div class="col-md-8 col-md-offset-2">
    <h1>UserTable
        <a data-ng-click="new()" href="registrousuario.php" class="btn btn-primary pull-right menu " data-toggle="modal"
                                    data-target="#turtle-info"
                                    ><i class="fa fa-user-plus" aria-hidden="true"  ></i>&nbsp;New User</a>
    </h1>
</div>
<div class="col-md-8 col-md-offset-2" >
        ...
        <tbody>
          ...
          <td>
                    <button data-toggle="modal"
                                    data-target="#turtle-info" class="btn btn-xs btn-primary" data-ng-click="update($index)" data-ng-hide="editRow==$index" style="min-width:70px;">
